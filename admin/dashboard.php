		...
		<div class="page-container">
			...
			<div class="left-content">
				<div class="mother-grid-inner">
					...
					<!--header end here-->
					<ol class="breadcrumb">
						<li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a> <i class="fa fa-angle-right"></i>
						</li>
					</ol>
					<!--four-grids here-->
					<div class="four-grids">
						<div class="col-md-3 four-grid">
							<div class="four-agileits gradient-bg">
								<div class="icon">
						...
						<div class="col-md-3 four-grid">
							<div class="four-agileinfo gradient-bg">
								<div class="icon">
						...
						<div class="col-md-3 four-grid">
							<div class="four-w3ls gradient-bg">
								<div class="icon">
						...
						<div class="col-md-3 four-grid">
							<div class="four-wthree gradient-bg">
								<div class="icon">
